...
class AudioTools:
    ...
    def load_audio(self, file_name: str = "", play: bool = False) -> tuple:
        signal, sampling_rate = librosa.load(file_name, sr=self.sampling_rate)
...
if __name__ == '__main__':
    audio = AudioTools(audio_config={'win_length': 64e-3, 'hop_percent': 0.5208333333, 'sampling_rate': 16000})
